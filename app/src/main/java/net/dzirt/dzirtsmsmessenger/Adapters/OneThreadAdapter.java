...
import net.dzirt.dzirtsmsmessenger.SmsData;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by Dzirt on 03.03.2018.
 */

public class OneThreadAdapter extends BaseAdapter {

    private List<SmsData> data = new ArrayList<SmsData>();  //SMS list
    private LayoutInflater inflater;

    public OneThreadAdapter(Context mContext) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflater.inflate(R.layout.one_thread_list_item, null);
